...
if(_81.showPageList){
var ps=$("<select class=\"pagination-page-list form-control\"></select>");
...
if(opts.maximizable){
$("<a class=\"panel-tool-max\" href=\"javascript:void(0)\"><i class='fa fa-tasks'></i></a>").appendTo(tool).bind("click",function(){
...
break;
case "warning":
_265="<div class=\"messager-icon messager-warning\"><i class='fa fa-warning'></i></div>"+_265;
break;
}
...
$('.datagrid-header-row').addClass('datagrid-row-selected');
if(opts.idField){
...
$('.datagrid-header-row').removeClass('datagrid-row-selected');
if(opts.idField){
